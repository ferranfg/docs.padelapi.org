...
Padel Analyst is an [MCP (Model Context Protocol)](https://modelcontextprotocol.io/introduction) server that connects your AI assistant to professional padel data, so you can ask in natural language without writing any code. Connect it in three steps:
