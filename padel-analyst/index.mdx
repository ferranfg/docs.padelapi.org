...
<Steps>
  ...
  <Step title="Connect your AI assistant">
    ...
    <CardGroup cols={2}>
      <Card title="Connect to ChatGPT" icon="comments" href="/padel-analyst/chatgpt-plugin">
        Install the Padel Analyst app in ChatGPT, no setup required.
      </Card>
...
| `simulate-match` | Estimate the win probability of a matchup from the players' Elo ratings |
