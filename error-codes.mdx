---
title: "Error Codes"
description: "Understanding Padel API error responses and how to handle them"
---
...
2. Wait before retrying (check the `Retry-After` header if provided)
...
<Tip>
  Use caching strategies to minimize repeated requests for the same data.
</Tip>
