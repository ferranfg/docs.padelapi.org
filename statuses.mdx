...
<AccordionGroup>
  ...
  <Accordion title="Which statuses are permanent?">
    Some match statuses are permanent once set and will never change: `finished`, `retired`, `walkover`, `bye` and `not_played`. Others are variable and will change as the match progresses: `scheduled`, `live`, and `ended`.
  </Accordion>
</AccordionGroup>
