...
|---|---|
| **80 to 100** | A late round between two of the best pairs on tour with no clear favourite. A handful per season, sometimes none in a given tournament |
...
| **20 to 39** | Predictable, or early, or both. A seeded pair against a qualifier, a lopsided round of 32 |
| **0 to 19** | An opening round mismatch. The result is close to settled before the warm-up |

For a concrete anchor: the men's number one pair against the pair ranked just behind them, **in a final**, scores **84**. The same two pairs meeting in a round of 16 score lower, and an opening round where one side wins 96 times out of 100 lands in the teens.
...
<AccordionGroup>
  ...
  <Accordion title="Which padel match should I watch today?">
    The highest rated one that fits your schedule. Anything above 80 is a rare fixture worth rearranging your evening for, the 60s and 70s are reliably good matches, and below 40 you are usually watching a formality. Cross the list with the estimated start times to pick what is actually playable in your day.
  </Accordion>
