...
<Steps>
  ...
  <Step title="What is at stake" icon="trophy">
    The round. A final counts for more than a semi-final, which counts for more than a quarter-final, down to the opening rounds. Enough to break ties between comparable matches, not enough to push a dull final above a great quarter-final. This ingredient only applies inside the main draw: matches in any other draw are rated on the other two alone.
  </Step>
</Steps>
