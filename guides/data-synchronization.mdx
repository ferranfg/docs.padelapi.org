...
| Data type     | Recommended frequency         | Key endpoints |
|---------------|-------------------------------|---------------|
| Tournaments   | Weekly                        | [`/seasons/{id}/tournaments`](/api-reference/season/list-season-tournaments) |
| Players       | After each tournament week    | [`/players/{player}`](/api-reference/player/show-player) |
| Matches       | After each tournament         | [`/tournaments/{tournament}/matches`](/api-reference/tournament/list-tournament-matches) |
